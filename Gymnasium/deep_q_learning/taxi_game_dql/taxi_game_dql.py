...
class TaxiGameDQL:
    ...
    def train(self, num_episodes, render=False):
        ...
        torch.save(policy_dqn.state_dict(), "taxi_game_dql.pt")
    ...
    def test(self, episodes, is_slippery=False):
        ...
        policy_dqn.load_state_dict(torch.load("taxi_game_dql.pt"))
        policy_dqn.eval()
...
if __name__ == "__main__":
    ...
    taxi_game = TaxiGameDQL()
    taxi_game.train(10000)
    taxi_game.test(10)
